const iconData = [
  {
    icon: "💃🏻",
    message:
      "I spend a lot of my free time dancing! Take a look at some of my dancing here (hint I am in the white dress):",
    button: true,
    link: "https://www.youtube.com/watch?v=126sOanaJdo&list=PLa2VpjRuWOYsTJEXwrTMBnOu7-5q3-S-O&index=51",
  },
  { icon: "👋", message: "Welcome to my portfolio! Hope you enjoy!", button: false, link: "" },
  {
    icon: "🏺︎",
    message: "One of my hobbies is ceramics! Take a look at some of my creations here:",
    button: false,
    link: "https://your-wix-site.com/gravity",
  },
  { icon: "🧵︎", message: "Are you a fan of embroidery? I am!", button: false, link: "" },
  {
    icon: "🦀︎",
    message: "Currently residing in Boston. Lots of seafood around here...",
    button: false,
    link: "",
  },
  { icon: "🏙︎", message: "Fun fact: I'm from Toronto!", button: false, link: "" },
  {
    icon: "✏︎",
    message:
      "I'm an avid urban sketcher and keep a sketchbook with me all the time! Take a look at my sketches!",
    button: false,
    link: "",
  },
  { icon: "🍁︎", message: "Just a falling leaf. Nothing to see here.", button: false, link: "" },
  {
    icon: "💧︎",
    message:
      "Oh no! I guess its drizzling on this webpage at the moment. Hope you brought some rainboots!",
    button: false,
    link: "",
  },
